...
class GetSymBalanceFromListWithDebtsUseCase @Inject constructor(
    postExecutorThread: PostExecutorThread,
    private val repository: FinanceRepository
) : BaseUseCase(postExecutorThread) {

    fun getSymBalanceFromListWithDebts(fromDate: String, toDate: String, list: List<String>) : Flowable<BigDecimal> {
